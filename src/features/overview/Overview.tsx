    ...
    <div className="max-w-3xl">
      ...
      <div className="grid grid-cols-4 gap-3 mb-6">
        <div className="flex flex-col items-center gap-1">
          ...
          <div className="text-hero font-semibold text-accent">
            {cmb.toFixed(0)}
          </div>
          <div className="text-label text-text-secondary">Combat</div>
        </div>
        <div className="flex flex-col items-center gap-1">
          <img src={`${WIKI_IMG}/Stats_icon.png`} alt="" className="w-5 h-5 opacity-50" onError={(e) => { e.currentTarget.style.display = "none"; }} />
          <div className="text-hero font-semibold">{totalLevel.toLocaleString()}</div>
          <div className="text-label text-text-secondary">Total Level</div>
        </div>
        <div className="flex flex-col items-center gap-1">
          <img src={`${WIKI_IMG}/Antique_lamp.png`} alt="" className="w-5 h-5 opacity-50" onError={(e) => { e.currentTarget.style.display = "none"; }} />
          <div className="text-hero font-semibold">
            {totalXp >= 1_000_000_000
              ? `${(totalXp / 1_000_000_000).toFixed(1)}B`
              : `${(totalXp / 1_000_000).toFixed(0)}M`}
          </div>
          <div className="text-label text-text-secondary">Total XP</div>
        </div>
        <div className="flex flex-col items-center gap-1">
          {maxedSkills >= 24 ? (
          ...
          <div className="text-label text-text-secondary">Maxed Skills</div>
        </div>
      </div>
