...
export function TableSkeleton({ rows = 5, cols = 4 }: { rows?: number; cols?: number }) {
  return (
    <div aria-busy="true" aria-label="Loading table" className="bg-bg-secondary rounded-lg overflow-hidden">
...
export function CardSkeleton() {
  return (
    <div aria-busy="true" aria-label="Loading content" className="bg-bg-secondary rounded-lg p-4 space-y-3">
