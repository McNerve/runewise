...
export const TRAINING_METHODS: Record<string, TrainingMethod[]> = {
  ...
  Mining: [
    { name: "Iron ore (power-mining)", xp: 35, xpPerHour: 55_000, levelReq: 15 },
    { name: "3-tick granite", xp: 75, xpPerHour: 100_000, levelReq: 45 },
    { name: "Motherlode Mine", xp: 60, xpPerHour: 45_000, levelReq: 30 },
    { name: "Gem rocks (Shilo)", xp: 65, xpPerHour: 55_000, levelReq: 40 },
    { name: "Volcanic Mine", xp: 95, xpPerHour: 85_000, levelReq: 50 },
    { name: "Amethyst", xp: 240, xpPerHour: 20_000, levelReq: 92 },
  ...
  Smithing: [
    ...
    { name: "Rune platebodies", xp: 375, xpPerHour: 300_000, levelReq: 99, itemId: 2363, itemName: "Runite bar", itemsPerAction: 5 },
  ],
  Fishing: [
    ...
    { name: "Karambwan", xp: 50, xpPerHour: 30_000, levelReq: 65 },
    { name: "Minnows", xp: 26.5, xpPerHour: 40_000, levelReq: 82 },
    { name: "Anglerfish", xp: 120, xpPerHour: 35_000, levelReq: 82 },
  ],
  Cooking: [
    { name: "Wines", xp: 200, xpPerHour: 490_000, levelReq: 35, itemId: 1987, itemName: "Grapes" },
    ...
    { name: "Anglerfish", xp: 230, xpPerHour: 300_000, levelReq: 84, itemId: 13439, itemName: "Raw anglerfish" },
  ],
  Firemaking: [
  ...
  Woodcutting: [
    ...
    { name: "Magic trees", xp: 250, xpPerHour: 25_000, levelReq: 75 },
  ...
  Herblore: [
    { name: "Attack potions", xp: 25, xpPerHour: 75_000, levelReq: 3, itemId: 249, itemName: "Guam leaf" },
    ...
    { name: "Super combat potions", xp: 150, xpPerHour: 420_000, levelReq: 90, itemId: 2436, itemName: "Super attack(4)" },
  ],
  Thieving: [
  ...
  Fletching: [
    ...
    { name: "Broad arrows", xp: 10, xpPerHour: 500_000, levelReq: 52, itemId: 11874, itemName: "Broad arrowheads" },
    { name: "Amethyst darts", xp: 21, xpPerHour: 700_000, levelReq: 90, itemId: 21350, itemName: "Amethyst dart tip" },
    { name: "Dragon darts", xp: 25, xpPerHour: 800_000, levelReq: 95, itemId: 11232, itemName: "Dragon dart tip" },
  ],
  Slayer: [
    { name: "Turael skipping", xp: 20, xpPerHour: 15_000, levelReq: 1 },
    { name: "Nieve/Steve tasks", xp: 50, xpPerHour: 35_000, levelReq: 1 },
    ...
    { name: "Hydra/high-level tasks", xp: 200, xpPerHour: 45_000, levelReq: 85 },
  ],
  Farming: [
  ...
  Construction: [
    ...
    { name: "Oak dungeon doors", xp: 600, xpPerHour: 350_000, levelReq: 74, itemId: 8778, itemName: "Oak plank", itemsPerAction: 10 },
    { name: "Mahogany tables", xp: 840, xpPerHour: 900_000, levelReq: 52, itemId: 8782, itemName: "Mahogany plank", itemsPerAction: 6 },
    { name: "Mahogany benches", xp: 840, xpPerHour: 950_000, levelReq: 77, itemId: 8782, itemName: "Mahogany plank", itemsPerAction: 6 },
  ...
  Sailing: [
    ...
    { name: "Island expeditions", xp: 300, xpPerHour: 60_000, levelReq: 30 },
  ],
};
