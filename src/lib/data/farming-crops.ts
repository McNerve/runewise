...
export const FARM_CROPS: FarmCrop[] = [
  ...
  // Trees (1 yield per patch, payment protection common)
  ...
  { name: "Palm tree", category: "Fruit Trees", seedName: "Palm tree seed", seedId: 5289, produceName: "Coconut", produceId: 5974, levelReq: 68, growthMinutes: 960, avgYield: 6, patches: 6 },
  { name: "Dragonfruit tree", category: "Fruit Trees", seedName: "Dragonfruit tree seed", seedId: 22877, produceName: "Dragonfruit", produceId: 22929, levelReq: 81, growthMinutes: 960, avgYield: 6, patches: 6 },
