...
const KEYBIND_LABELS_ALL: Record<string, { label: string; family: string }> = {
  ...
  progress: { label: "Progress", family: "Player" },
  "dps-calc": { label: "DPS Calc", family: "Combat" },
  "gear-compare": { label: "Gear Compare", family: "Combat" },
  bosses: { label: "Boss Guides", family: "Combat" },
  raids: { label: "Raid Guides", family: "Combat" },
  loot: { label: "Loot & Drops", family: "Combat" },
  slayer: { label: "Slayer Helper", family: "Combat" },
  market: { label: "Items", family: "Market" },
  "flip-journal": { label: "Flip Journal", family: "Market" },
  "money-making": { label: "Money Making", family: "Market" },
  spells: { label: "Spells", family: "Market" },
  "skill-calc": { label: "Skill Calc", family: "Calculators" },
  "dry-calc": { label: "Dry Calc", family: "Calculators" },
  "pet-calc": { label: "Pet Calc", family: "Calculators" },
  "production-calc": { label: "Recipe Calc", family: "Calculators" },
  timers: { label: "Farm Timers", family: "Calculators" },
  "xp-table": { label: "XP Table", family: "Calculators" },
  "training-plan": { label: "Training Plan", family: "Calculators" },
      ...
      <SettingsCard title="Attribution">
        <div className="space-y-1">
          {[
            ...
            { label: "07.gg Shooting Stars", href: "https://old.07.gg/", license: "Public API" },
