...
const KEYBIND_LABELS_ALL: Record<string, { label: string; family: string }> = {
  ...
  "skill-calc": { label: "Skill Calc", family: "Plan" },
  "dry-calc": { label: "Dry Calc", family: "Plan" },
  "pet-calc": { label: "Pet Calc", family: "Plan" },
  "production-calc": { label: "Recipe Calc", family: "Plan" },
  timers: { label: "Farm Timers", family: "Plan" },
  "xp-table": { label: "XP Table", family: "Plan" },
  "training-plan": { label: "Training Plan", family: "Plan" },
