...
export const POPULAR_DROPS: DropEntry[] = [
  // Raids
  { item: "Twisted bow", source: "Chambers of Xeric", rate: 998, category: "Raids", note: "Per raid at typical solo points. Scales with points." },
  { item: "Scythe of vitur", source: "Theatre of Blood", rate: 86, category: "Raids", note: "Team chest rate — personal odds rarer in teams." },
  { item: "Tumeken's shadow", source: "Tombs of Amascut", rate: 600, category: "Raids", note: "Per raid at ~150 invocations. Scales with invocation level." },
  { item: "Masori mask", source: "Tombs of Amascut", rate: 600, category: "Raids", note: "Per raid at ~150 invocations. Scales with invocation level." },
  { item: "Osmumten's fang", source: "Tombs of Amascut", rate: 196, category: "Raids", note: "Per raid at ~150 invocations. Scales with invocation level." },
  { item: "Dragon claws", source: "Chambers of Xeric", rate: 665, category: "Raids", note: "Per raid at typical solo points. Scales with points." },
  { item: "Dexterous prayer scroll", source: "Chambers of Xeric", rate: 587, category: "Raids", note: "Per raid at typical solo points. Scales with points." },
  { item: "Avernic defender hilt", source: "Theatre of Blood", rate: 86, category: "Raids", note: "Team chest rate — personal odds rarer in teams." },
  { item: "Ancestral hat", source: "Chambers of Xeric", rate: 665, category: "Raids", note: "Per raid at typical solo points. Scales with points." },
  { item: "Ancestral robe top", source: "Chambers of Xeric", rate: 665, category: "Raids", note: "Per raid at typical solo points. Scales with points." },
  { item: "Dragon hunter crossbow", source: "Chambers of Xeric", rate: 998, category: "Raids", note: "Per raid at typical solo points. Scales with points." },
  { item: "Masori body (f)", source: "Tombs of Amascut", rate: 600, category: "Raids", note: "Per raid at ~150 invocations. Scales with invocation level." },
  { item: "Lightbearer", source: "Tombs of Amascut", rate: 196, category: "Raids", note: "Per raid at ~150 invocations. Scales with invocation level." },
  { item: "Justiciar legguards", source: "Theatre of Blood", rate: 86, category: "Raids", note: "Team chest rate — personal odds rarer in teams." },
  { item: "Sanguinesti staff", source: "Theatre of Blood", rate: 86, category: "Raids", note: "Team chest rate — personal odds rarer in teams." },
